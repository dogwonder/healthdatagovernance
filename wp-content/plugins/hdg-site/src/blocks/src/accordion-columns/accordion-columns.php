		...
		if ( have_rows( 'accordion_columns' ) ) :
			...
			<div x-data="{ open: false }">
				<div class="hdg-accordion__section" :class="{ 'open': open }">
						...
						<div id="hdg-default-content-<?php echo get_row_index(); ?>" class="hdg-accordion__section-content stack" aria-labelledby="hdg-default-heading-<?php echo get_row_index(); ?>" x-on:click="!open">
