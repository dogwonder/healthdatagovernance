<header id="masthead" class="sigur-masthead" data-enabled="false">

    <div id="skiplink-container">
        <a href="#content" class="govuk-skip-link" data-module="govuk-skip-link"><?php esc_html_e( 'Skip to main content', 'sigur' ); ?></a>
    </div>

    <div class="sigur-masthead-container">

            <div class="sigur-masthead__logo">
                ...
                <span class="visually-hidden"><?php esc_html_e( 'Sigur Rós', 'sigur' ); ?></span>
                </a>
            </div><!-- .masthead__logo -->

            <nav id="site-navigation" class="main-navigation sigur-nav" aria-label="primary">
                ...
                <button class="nav-toggle" id="nav-toggle" aria-label="Show or hide Top Level Navigation" aria-controls="nav-primary" aria-expanded="false">
                    ...
                    <span class="visually-hidden"><?php esc_html_e( 'Menu', 'sigur' ); ?></span>
                </button>

                <div class="sigur-nav__wrapper">
